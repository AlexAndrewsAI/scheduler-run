...
def test_run_system_command_success(caplog):
...
def test_run_system_command_failure(caplog):
...
def test_schedule_command_system_type(caplog):
...
def test_schedule_command_unsupported_type(caplog):
...
def test_load_schedule_success(tmp_path, caplog):
...
def test_load_schedule_file_not_found(tmp_path, caplog):
...
def test_load_schedule_invalid_row(tmp_path, caplog):
